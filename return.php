...
$PAGE->set_url(new moodle_url('/enrol/nephilazip/return.php', ['courseid' => $courseid, 'userid' => $userid, 'ref' => $clientref]));
...
if ($is_enrolled) {
    ...
    echo '<a href="' . $CFG->wwwroot . '/enrol/nephilazip/check_status.php?courseid=' . $courseid . '&ref=' . urlencode($clientref) . '" class="btn btn-info">Check Payment Status</a>';
    echo $OUTPUT->box_end();
}
